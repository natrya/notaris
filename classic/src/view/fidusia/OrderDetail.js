Ext.define('Admin.view.fidusia.OrderDetail', {
    extend: 'Ext.grid.Panel',
    itemId: 'orderdetailfidusiaGrid',
    id: 'orderdetailfidusiaGrid',
    xtype: 'orderdetailfidusia',
    store: 'orderdetailfidusia',
    controller: 'orderdetailfidusia',
    requires: [
        'Ext.grid.filters.Filters'
    ],
    initComponent: function(){
        Ext.create('Admin.store.OrderDetailfidusia',{});
        Ext.apply(this, {
            plugins: ['gridfilters'],
            dockedItems: [{
                xtype: 'toolbar',
