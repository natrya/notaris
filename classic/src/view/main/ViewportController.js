Ext.define('Admin.view.main.ViewportController', {
    ...
    setCurrentView: function(hashTag) {
        ...
        var me = this,
            ...
            view = node ? node.get('view') : 'authentication.Login',
    ...
    onMainViewRender:function() {
        var me=this;
        Ext.Ajax.request({
            url : 'resources/php/classes/cekLogin.php',
            method: 'POST',
            headers: { 
                ...
                if (response.success == true){
                    ...
                    Loader.loadScript({
                        ...
                        onLoad:function(){
                            ...
                            Ext.getCmp('idtopuser').setText(Dataku.nama);
    ...
    onRouteChange:function(id){
       //supaya dilogout apabila session sudah habis
        if (id != 'authentication.login'){
            Ext.Ajax.request({
                url : 'resources/php/classes/test.php',
                method: 'POST'
            });
        }
    ...
    onLogout: function(){
        var me=this;
        Ext.Ajax.request({
            url : 'resources/php/classes/logout.php',
            method: 'POST',
            callback: function(){
    ...
    onPassword: function(){
       Ext.create('Admin.view.main.GantiPassword',{create:true}); 
    }
});
