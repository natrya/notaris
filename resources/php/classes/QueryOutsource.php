...
class QueryOutsource
{
    ...
    public function getResultsId(stdClass $params)
    {
        ...
        $query = "select count(idusr) as total from usr where nama like '%".$q."%' AND level=3;";
        $query.= "SELECT idusr,nama FROM usr where nama like '%".$q."%' AND level=3 LIMIT ".$mulai.",".$banyak;
